...
<title>Envio de Torpedo SMS grátis - Dúvidas de como usar nosso portal de envio de sms?</title>
<meta name="description" content="Dúvias de como enviar torpedo sms gratis? " /> 
<meta name="keywords" content="sms de graça,mensagem gratis,sms,sms gratis, envio de sms, gratisms, gratis sms, webservice sms, webservicesms, tim, vivo, claro, tim sms, vivo sms, claro sms, sms rapido, de graça" /> 
...
<!---------------------MENU PRINCIPAL------------------------> 
               ...
               <div id="linha"> </div>
                  ...
                  <div id="conteudo_central">
							<div id="esquerdo_central">
							 ...
							 <div id="form_sms" style="margin-top:20px;">
                               <h2 class="form_subtitulo" style=" border-top:4px solid #9576A3; background:url(<?=base_url();?>images/contato_sub.png) no-repeat left;">formulário de envio de mensagens via sms</h2>
                               <div class="formulario_sms">
                                  <div class="formulario_sms_destino">
                                        <p class="inf_destino"> Informações do destinatário</p>
                                        <form>
                                              <select  class="status_ddd" rel="status_ddd" disabled="disabled">
                                                <option value="11">11</option>
                                            </select> 
                                            <input class="status_num_destino" type="text" size="9" value="Gratisms" disabled="disabled" rel="form_num_destino"/>
                                            <br class="clear" />
                                            <label class="status_msg">Restam <span id="contador">250</span> letras</label>
                                             <br class="clear" />
                                            <textarea onkeyup="limitaTextarea(this.value)" rel="texto" class="status_msg">Escreva sua mensagem</textarea>
                                         </form>                                          
                                    </div>  
				...
				<option value="99">99</option>
                                            ...
                                            <br class="clear" />
                                            <button type="submit" class="enviar_sms" title="Enviar mensagem" id="mensagem">enviar mensagem</button>
                                            
                                       </form>                                      
                                    </div> 
                                  <div class="atencao_form">
                                        <img src="<?=base_url();?>images/atencao_icon.png" class="attention" alt="Atenção" title="Atenção" />
                                       <p class="at_form">Gratisms o único site brasileiro de envio de sms grátis.</p>
                                  </div>
                                                                    
                               </div>                                 
                    </div> 

								 <div id="webservice" style="clear:both;margin-top:5px;">
                  <div class="webservice_conteudo">
                      <h2 class="web_subtitulo">webservice</h2>
                      <p class="web_text">Se você é um desenvolvedor de software ou profissional da área, oferecemos 
                      também um Gateway para envio de mensagens de SMS (torpedos) via protocolo HTTP, 
                      que pode ser usado com facilidade em qualquer liguagem de programação, incluindo ASP, ASP.Net, PERL e PHP.  </p>
                 </div>  
               </div>					
					 <div id="empresa">
                      <h2 class="empresa_subtitulo">grátis sms em sua empresa</h2>
                      <p class="empresa_text">Enviar mensagens de texto para o celular dos seus clientes é uma forma poderosa de agregar valor ao seu negócio. SMS tem uma altíssima taxa de leitura, deixando você mais perto dos seus consumidores atuais e potenciais.</p> 
                      <p class="empresa_text">Nosso serviço de SMS permite que você envie uma mensagen instantânea para praticamente qualquer telefone celular.</p>
                      <p class="empresa_text">Garantimos a confidencialidade e privacidade das informações dos seus contatos e envios. Todas as informações da sua conta são rigorosamente armazenadas em servidores protegidos com anti-virus e "firewalls". Somente usuários autorizados, com seu login e senha, terão acesso aos seus dados.</p> 
                </div>			
